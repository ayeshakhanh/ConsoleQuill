...
#[derive(Debug)]
pub struct ConsoleQuillProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ConsoleQuillProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ConsoleQuill processing");
    
    let mut processor = ConsoleQuillProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ConsoleQuillProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ConsoleQuillProcessor::new(false);
